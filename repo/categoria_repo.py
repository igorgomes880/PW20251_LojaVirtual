...
def inserir_categoria(categoria: Categoria) -> Categoria:
    ...
    cursor.execute(INSERT_CATEGORIA, 
        (categoria.nome, categoria.cpf, categoria.telefone, categoria.email, categoria.data_nascimento))
...
def atualizar_categoria(categoria: Categoria) -> bool:
    ...
    cursor.execute(UPDATE_CATEGORIA, 
        (categoria.nome, categoria.cpf, categoria.telefone, categoria.email, categoria.data_nascimento, categoria.id))
    conexao.commit()
    conexao.close()
